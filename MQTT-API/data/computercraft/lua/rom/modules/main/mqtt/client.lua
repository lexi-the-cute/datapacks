...
if _HOST ~= nil and not string.find(_HOST, "ComputerCraft") then
	local os = require("os")
end
...
function client_mt:__init(args)
	...
	if a.connector == nil then
		if _HOST ~= nil and string.find(_HOST, "ComputerCraft") then
			a.connector = require("mqtt.cc_websocket")
		elseif a.secure then
